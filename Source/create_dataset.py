...
if __name__ == "__main__":
    ...
    #Mstar_gal = Mstar_gal*1e10   
    UID, x_gal, y_gal, z_gal, xp_gal, yp_gal, sector_gal, Mstar_gal, SFR_gal, host_gal, dist_gal, log10Mcd_gal, mgas_gal, vx_gal, vy_gal, vz_gal, dv_gal, vr_gal, vt_gal = np.loadtxt(simdir+'galaxies_box2b_snap26_z047.txt.gz', skiprows=1, unpack=True)
    ...
    UID, x_halo, y_halo, z_halo, xp_halo, yp_halo, sector_halo, M_500c_halo, r_500c_halo, gfr_halo, star_fr_halo, T_halo, Lx_halo, Y500c_halo, Msat_halo, cshift_halo, vx_halo, vy_halo, vz_halo = np.loadtxt(simdir+'cluster_box2b_snap26_z047.txt.gz', skiprows=1, unpack=True)
    ...
    tab = np.column_stack((pos_gal,Mstar_gal))
